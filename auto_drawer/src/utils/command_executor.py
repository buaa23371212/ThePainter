...
# 绘图命令模块导入区
# ==============================
from auto_drawer.src.utils.drawer.circle_drawer import select_circle_tool, draw_circle_command
from auto_drawer.src.utils.drawer.ellipse_drawer import select_ellipse_tool, draw_ellipse_command
from auto_drawer.src.utils.drawer.square_drawer import select_square_tool, draw_square_command
...
from auto_drawer.src.utils.drawer.polyline_drawer import draw_polyline_command

# ==============================
# 颜色填充模块导入区
# ==============================
from auto_drawer.src.utils.colorer.colorer import select_fill_tool, choose_color, fill_color

# ==============================
# 文本输入模块导入区
# ==============================
from auto_drawer.src.utils.texter.texter import select_texter_tool, create_text
...
def _dispatch_shape_command(args):
    ...
    shape_commands = {
        ...
        'polyline':(select_line_tool, draw_polyline_command)
    }
